...
function loadContent() {
  ...
  // Redirect to Zomato for order-online
  if (hash === 'order-online') {
    window.open('https://www.zomato.com', '_blank', 'noopener');
    // Return to home page after opening Zomato
    window.location.hash = '#home';
    return;
  }
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Setup service worker for better offline experience if supported
  if ('serviceWorker' in navigator) {
